      ...
      <CardContent className="p-6 flex flex-col h-full">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <h3 className="text-xl font-bold text-foreground mb-1" data-testid="tool-name">
              {tool.name}
            </h3>
            <p className="text-sm text-muted-foreground mb-2" data-testid="tool-tagline">
              {tool.tagline}
            </p>
        ...
        {getArchetypeExplanation() && (
          <div className="mb-4 p-3 bg-gradient-to-br from-primary/5 to-accent/5 rounded-lg border border-primary/10">
        ...
        <Collapsible open={showDetails} onOpenChange={setShowDetails}>
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
              size="sm"
              className="w-full mb-2 text-xs font-semibold text-muted-foreground hover:text-foreground"
            >
        ...
        <div className="mt-auto pt-4 border-t">
          ...
          >
            <Button className="w-full bg-primary hover:bg-primary/90 text-white" data-testid="button-try-tool">
              Try {tool.name}
